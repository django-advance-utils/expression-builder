...
class MathsOperationsTests(unittest.TestCase):
    ...
    def test_atan(self):
        ...
        self.assertAlmostEqual(0.46364760900080615, result['result'])
    ...
    def test_acos(self):
        ...
        self.assertAlmostEqual(1.0471975511965976, result['result'])
    ...
    def test_asin(self):
        ...
        self.assertAlmostEqual(0.5235987755982988, result['result'])
